...
<div class="box-header panel-heading borde martesColor sombra">
 <h3 class="box-title">
  <font color="white ">Formulario | Registros de Personas</font>    
 </h3>
</div>
<!-- Progress Bar I ----------------------------------------------------- -->		
 <div class="col-xs-12">
       ...
       <input type="hidden" id="ide" name="ide"><!--  -->
        <div class="form-group borde sombra ">
         <span class="input-group-addon">
          <label for="nombre" class="text-success claseInput1">* Nombre</label>
         </span>
         <input type="text" name="nombre" class="form-control" id="idNombre" required autofocus>
        </div>
      </div>
     <!-- --------------------------------------------- -->
      <div class="col-xs-12 col-sm-6 col-md-4 col-lg-5">
       <div class="form-group borde sombra">
        <span class="input-group-addon">
         <label for="ap_paterno" class="text-success claseInput2">* Apellido Paterno</label>
        </span>
        <input type="text" name="ap_paterno" id="idApPaterno" class="form-control">
       </div>
      </div>
     <!-- --------------------------------------------- -->
      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-5">
       <div class="form-group borde sombra">
        <span class="input-group-addon">
         <label for="ap_materno" class="text-success claseInput3">* Apellido Materno</label>
        </span>
        <input type="text" name="ap_materno" id="idApMaterno" class="form-control">
       </div>
      </div>
      <!-- -------------------------------------- -->
      </div>
