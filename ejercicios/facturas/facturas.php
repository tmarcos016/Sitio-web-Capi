...
<!-- ////////////////////////////////////////////////////////////////////////  -->
<!-- TITULO FORMULARIO - CALCULADORA ---------------------------------------- -->
<div class="box-header panel-heading borde btn-success sombra">
 <h3 class="box-title">
  <font color="white ">Formulario | Datos para facturación</font>  
 </h3>
</div>
<!-- Progress Bar I ----------------------------------------------------- -->		
<div class="col-xs-12">
...
<div class="container-fluid">
 ...
 <!-- ---------------------------------------------- -->
  ...
  <form action="" method="POST" id="form_configuracion">
   <table border="1" id="tabla" class="table table-condensed table-bordered table-striped text-center">
    <!-- ---------------------------------------------- -->
    <tr>
     <td>
       ...
       <input type="hidden" id="ide" name="ide"><!--  -->
        <div class="form-group borde sombra ">
         <span class="input-group-addon">
          <label for="id_cliente" class="text-success">
              * Nombre de cliente representante</label>
         </span>
         <select name="id_cliente" id="idCliente" class="form-control h-100 cInput1 claseInput1">
          <?php 
    ...
    <tr>
     ...
     <!-- -------------- -->
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
       <div class="form-group borde sombra">
        <span class="input-group-addon">
         <label for="duracion_garantia" class="text-success">
             * Periodo de garantia</label>
        </span>
        <input type="text" name="duracion_garantia" id="idDGarantia" class="form-control cInput2 claseInput2 claseChangeClass" disabled autofocus>
       </div>
      </div>
     <!-- -------------- -->
      ...
      <div class="form-group borde sombra">
        <span class="input-group-addon">
         <label for="costo_garantia" class="text-success claseInput3">
             * Costo de la garantia</label>
        </span>
        <input type="text" name="costo_garantia" id="idCGarantia" class="form-control cInput3 claseInput3 claseChangeClass" disabled autofocus>
       </div>
      </div>
    <!-- -------------- -->
     </td>
    ...
    <tr>
     <td>
      ...
      <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
       <input type="hidden" id="ide" name="ide">
        <div class="form-group borde sombra">
         <span class="input-group-addon">
          <label type="number" id="num1" for="num1" class="claseInput1 w-100">
              Opciones</label>
         </span>
         <div class="btn-group" role="group">
          <button id="btnGroupDrop1" type="button" class="btn btn-secondary dropdown-toggle text-info whiteColor" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Página Oficial
          </button>
          <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
           <a class="dropdown-item text-info" href="https://www.akky.mx/">Akky</a>
      ...
      <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
       <div class="form-group borde sombra">
        <span class="input-group-addon">
         <label for="proveedor_dominio" class="text-success claseInput3">
             * Proveedor de Dominio</label>
        </span>
        <input type="text" name="proveedor_dominio" id="idPDominio" class="form-control" disabled autofocus>
       </div>
      </div>
     <!-- --------- -->
     <!-- -------- -->
     <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
      <div class="form-group borde sombra">
        <span class="input-group-addon">
         <label for="costo_dominio" class="text-success claseInput3">
             * Costo de Dominio</label>
        </span>
        <input type="text" name="costo_dominio" id="idCDominio" class="form-control" disabled autofocus>
       </div>
      </div>
     <!-- --------- -->
     </td>
    ...
    <tr>
     <td>
       ...
       <input type="hidden" id="ide" name="ide">
        <div class="form-group borde sombra">
         ...
         <div class="btn-group" role="group">
          ...
          <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
           <a class="dropdown-item text-info" href="https://www.hostgator.mx/web-hosting">HostGator</a>
           <a class="dropdown-item" href=""></a>
          </div>
         </div>
        </div>
      ...
      <!-- ------------- -->
        <div class="col-xs-4 col-sm4 col-md4 col-lg4">
         <div class="form-group borde sombra">
          <span class="input-group-addon">
           <label for="proveedor_hosting" class="text-success claseInput3">
               * Proveedor de Hosting</label>
          </span>
          <input type="text" name="proveedor_hosting" id="idPHosting" class="form-control" disabled autofocus>
         </div>
        </div>
        <!-- ------------- -->
        <div class="col-xs-3 col-sm3 col-md3 col-lg3">
         <div class="form-group borde sombra">
          <span class="input-group-addon">
           <label for="costo_hosting" class="text-success claseInput3">
               * Costo de Hosting</label>
          </span>
          <input type="text" name="costo_hosting" id="idCHosting" class="form-control" disabled autofocus>
         </div>
        </div>
        <!-- ------------- -->
       </td>
      ...
      <tr>
       ...
       <!-- ------------- -->
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
         <div class="form-group borde sombra">
          <span class="input-group-addon">
           <label for="cantidad_modulos" class="text-success claseInput3">
               * Cantidad de Modulos</label>
          </span>
          <input type="text" name="cantidad_modulos" id="idCantModulos" class="form-control" disabled autofocus>
         </div>
        </div>
       <!-- ------------- -->
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
         <div class="form-group borde sombra">
          <span class="input-group-addon">
           <label for="costo_modulos" class="text-success claseInput3">
               * Costo de Modulos</label>
          </span>
          <input type="text" name="costo_modulos" id="idCModulos" class="form-control" disabled autofocus>
         </div>
        </div>
       <!-- ------------- -->
        ...
        <div class="form-group borde sombra">
        <span class="input-group-addon">
         <label for="costo_total" class="text-success claseInput3">
             * Costo total</label>
        </span>
        <input type="text" name="costo_total" id="idCTotal" class="form-control" disabled autofocus>
       </div>
        </div>
       <!-- ------------- -->
       </td>
     ...
     <tr>
      <td>
       <div class="col-xs-2">
        <button class="btn buttonColorCSS borde sombra" type="button" id="btn-reset" onclick="inicio()" disabled autofocus>
         <i class="fa fa-repeat"></i> Reset</button>		
       </div>
       <div class="col-xs-2">
       <input type="submit" value="Guardar" class="btn btn-success borde sombra" id="btn-guardar" onclick="fGuardar()" disabled autofocus>
      </div>
      <div class="col-xs-2">
        <button class="btn btn-info borde sombra" type="button" id="btn-math" onclick="calcular()" disabled autofocus>
  ...
  <!-- /////////////////////////////////////////////// -->			
    ...
    <div class="boxA box-danger panel panel-primary animated slideInUp borde sombra">
     <div class="box-header panel-heading borde miercolesColor sombra">
      <h3 class="box-title">
       <font color="white">Configuracion de Contratos | Lista de Facturas</font>    
      </h3>
     </div>
        ...
        <div class="table-responsive panel-body">
         ...
         <table id="lista_facturas" class="table table-striped table-bordered" cellspacing="0" width="100%">
          <thead class="btn-info">
              <th width="10%">#</th>
              <th    width="">Cliente</th>
              <th width="">Garantia</th>
              <th width="5%">Costo Garantia</th>
              <th width="15%">Prov Dominio</th>
              <th width="5%">Costo Dominio</th>
              <th width="15%">Prov Hosting</th>
              <th width="5%">Costo Hosting</th>
              <th width="5%">Cant Modulos</th>
              <th width="15%">Costo Modulos</th>
              <th width="5%">Costo Total</th>
              <th            >Opciones</th>
          </thead>
          <tbody class="">
              <tr>
...
$('#lista_facturas').dataTable().fnDestroy();
    ...
    {  
        ...
        title:'CODE FINERY PRODUNCTIONS | Lista de Personas',
        exportOptions:{
            columns:':visible'
        }
    },
...
"columns":[{
        ...
        {
            "data":"duracion_garantia"
        },
        {
            "data":"costo_garantia"
        },
        {
            "data":"proveedor_dominio"
        },
        {
            "data":"costo_dominio"
        },
        {
            "data":"proveedor_hosting"
        },
        {
            "data":"costo_hosting"
        },
        {
            "data":"cantidad_modulos"
        },
        {
            "data":"costo_modulos"
        },
