...
<div class="box-header panel-heading borde martesColor sombra">
 <h3 class="box-title">
  <font color="white ">Formulario | Registros de Facturación</font>    
 </h3>
</div>
<!-- Progress Bar I ----------------------------------------------------- -->		
 <div class="col-xs-12">
       ...
       <input type="hidden" id="ide" name="ide"><!--  -->
        <div class="form-group borde sombra ">
         <span class="input-group-addon">
          <label for="siglas" class="text-success claseInput1">* Nombre de Representante</label>
         </span>
         <!-- <input type="text" name="siglas" id="siglas" class="form-control"> -->
         <input type="text" name="siglas" class="form-control claseChangeClass claseInput1" id="siglas" required autofocus>
        </div>
      </div>
     <!-- --------------------------------------------- -->
      <div class="col-xs-12 col-sm-6 col-md-4 col-lg-5">
       <div class="form-group borde sombra">
        <span class="input-group-addon">
         <label for="carreras" class="text-success">* Nombre de Organización</label>
        </span>
        <input type="text" name="carreras" id="carreras" class="form-control">
       </div>
      </div>
     <!-- --------------------------------------------- -->
      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
       <div class="form-group borde sombra">
        <span class="input-group-addon">
         <label for="tetra" class="text-success">* RFC</label>
        </span>
        <input type="text" name="tetra" id="tetra" class="form-control">
       </div>
      </div>
     <!-- --------------------------------------------- -->
      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
       <div class="form-group borde sombra">
        <span class="input-group-addon">
         <i class="fas fa-question-circle text-success" id="fNacimientoHelp"></i>
         <label for="fecha_inicial" class="text-success">* Fecha de Registro</label>
        </span>
        <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="fecha_inicial" data-link-format="yyyy-mm-dd">
         <input class="form-control" size="16" type="date" value="" id="fecha_inicial" name="fecha_inicial">
        </div>
       </div>
      </div>
     <!-- --------------------------------------------- -->
      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
       <div class="form-group borde sombra">
        <span class="input-group-addon">
        <i class="fas fa-question-circle text-success" id="fNacimientoHelp"></i>
         <label for="fecha_final" class="text-success">* Ultima Actualización</label>
        </span>
        <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="fecha_final" data-link-format="yyyy-mm-dd">
         <input class="form-control" size="16" type="date" value="" id="fecha_final" name="fecha_final">
        </div>
       </div>
      </div>
      <!-- -------------------------------------- -->
...
<!-- BUTTONS ----------------------------------------------------- -->
      ...
      <!-- -------------------------- -->
      <div class="col-xs-2">
       <button class="btn btn-success borde sombra" type="button" id="btn-guardar" onclick="fGuardar()" autofocus>
       <i class="fa fa-database"></i>Guardar Datos</button>
      </div>
...
<!-- fin de panel principal  -->
    ...
    <div class="boxA box-danger panel panel-primary animated slideInUp borde sombra">
     <div class="box-header panel-heading borde miercolesColor sombra">
      <h3 class="box-title">
       <font color="white">Configuracion de Facturas | Lista de Registros</font>    
      </h3>
     </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive panel-body">
                        <!-- TABLA .html ----------------------------------- -->
                        <table id="lista_carreras" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead class="btn-info">
                                <th width="5%">#</th>
                                <th width="10%">Nombre de Representante</th>
                                <th width="">Nombre de Organización</th>
                                <th width="20%">RFC</th>
                                <th width="10%">Fecha Registro</th>
                                <th width="10%">Fecha Ultima Actualización</th>
                                <th>Opciones</th>
                            </thead>
                            <tbody>
                                <tr>
...
$("#btn-guardar").click(function(){
    ...
    console.log(siglas,carreras,tetra,fecha_inicial,fecha_final);


    // IF - 
    if ($("#carreras").val() == "" || $("#siglas").val() == "" || $("#tetra").val() == "" || $("#fecha_inicial").val() == "" || $("#fecha_final").val() == "" ) {
    ...
    $.ajax({
        ...
        success:function(respuesta){
            // fCargarTabla();
            cargar_tabla();
            alertify.success("Datos para facturación fueron registrados correctamente");
...
$('#lista_carreras').dataTable().fnDestroy();
     $('#lista_carreras').DataTable( {
    'language':{
...
$.ajax({
    ...
    success:function(respuesta){
        ...
        $("#ide").val(array[0]);
        $("#siglas").val(array[1]);
        $("#carreras").val(array[2]);
        $("#tetra").val(array[3]);
        $("#fecha_inicial").val(array[4]);
        $("#fecha_final").val(array[5]);
    },
    error:function(xhr,status){
        alert("error");
    }
