...
<div class="box-header panel-heading borde martesColor sombra">
 <h3 class="box-title">
  <font color="white">Formulario | Registros de Clientes</font>    
 </h3>
</div>	
<!-- INPUTS FORMULARIO---------------------------------------------- -->
    ...
    <div class="row borde sombra">
     ...
     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <form action ="insertar_configuracion.php" method="POST">  
         <div class="container">
          <div class="row"><hr>Eliga porfavor el nombre de la persona que desea dar de alta como cliente representante.
           <!-- --------------------------- -->
...
<!-- fin de panel principal  -->
    ...
    <div class="boxA box-danger panel panel-primary animated slideInUp borde sombra">
     <div class="box-header panel-heading borde miercolesColor sombra">
      <h3 class="box-title">
       <font color="white">Configuracion de Clientes | Lista de clientes</font>  
      </h3>
     </div>
        ...
        <div class="table-responsive panel-body">
         ...
         <table id="lista_clientes" class="table table-striped table-bordered" cellspacing="0" width="100%">
          <thead class="btn-info">
              <th width="10%">#</th>
              <th    width="">Cliente Representante</th>
...
$("#btn-guardar").click(function(){
    ...
    $.ajax({
        ...
        success:function(respuesta){
            // fCargarTabla();
            cargar_tabla();
            alertify.success("Datos de representante fueron registrados correctamente.");
...
$('#lista_clientes').dataTable().fnDestroy();
    ...
    {  
        ...
        title:'CODE FINERY PRODUNCTIONS | Lista de Clientes',
        exportOptions:{
            columns:':visible'
        }
    },
